...
namespace PatcherYRpp
{
    ...
    public struct Matrix3DStruct
    {
        ...
        {
            var func = (delegate* unmanaged[Thiscall]<ref Matrix3DStruct, ref SingleVector3D, ref SingleVector3D, float, void>)0x5AF550;
            func(ref this, ref p, ref t, roll);
        }

        public unsafe void LookAt2(SingleVector3D p, SingleVector3D t, float roll)
        {
            var func = (delegate* unmanaged[Thiscall]<ref Matrix3DStruct, ref SingleVector3D, ref SingleVector3D, float, void>)0x5AF710;
            func(ref this, ref p, ref t, roll);
        }
    }
}
