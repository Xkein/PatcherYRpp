...
namespace PatcherYRpp
{
    ...
    public struct EBolt
    {
        ...
        public unsafe void Fire(CoordStruct point1, CoordStruct point2, int arg18 = 0)
        {
        ...
        public unsafe CoordStruct GetSourceCoords()
        {
            CoordStruct buffer = new CoordStruct();
            var func = (delegate* unmanaged[Thiscall]<ref EBolt, IntPtr, IntPtr>)0x4C2B40;
            Pointer<CoordStruct> buf = Pointer<CoordStruct>.AsPointer(ref buffer);
            func(ref this, buf);
            return buf.Data;
        }
